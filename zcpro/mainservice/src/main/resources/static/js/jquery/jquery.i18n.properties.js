  ...
  $.i18n.properties = function (settings) {
    ...
    var languagesFileLoadedCallback = function (languages) {
      ...
      for (var k = 0, m = files.length; k < m; k++) {
        ...
        /*g20416 20161116 取那么多没啥用 我每次都取一个 去掉 .properties 我要用后台来读取properties文件*/
        inUsedFileName = settings.path + files[k] + '_' + settings.language;
//        loadAndParseFiles([defaultFileName,shortFileName,longFileName], settings);
        loadAndParseFiles([inUsedFileName], settings);
